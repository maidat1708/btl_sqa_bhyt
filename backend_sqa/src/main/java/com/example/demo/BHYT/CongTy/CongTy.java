...
public class CongTy {
    ...
    public CongTy(Integer id, String idBHYT, String ten, String diaChi, Double  mucDong, Double  daDong, Double  conNo, Integer soLuong, Date tuNgay, Date denNgay, Integer dongTheo, String idBHYTPhuong, String listCaNhan) {
        this.id = id;
        this.idBHYT = idBHYT;
        this.ten = ten;
        this.diaChi = diaChi;
